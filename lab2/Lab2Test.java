...
public class Lab2Test extends TestCase {
	...
	public void testPath() {
		...
		/////////////////////////////////////// if you change maze, this part will be changed
	...
	public void testStackPush(){
		...
		for(int i = 0; i < size; ++i) {
			...
			for(int j = i; j >= 0; --j) {
				assertTrue(student_solution.isequal_element(
					ptr,
					new element(size - j, j, j * j, (j == 0) ? null : ptr.below)
				));
				ptr = ptr.below;
			}
		}
	...
	public void testStackPop(){
		...
		for(int i = 0; i < size; ++i) {
			elements[i] = new element(size - i, i, i * i, (i == 0) ? null : elements[i - 1]);
		}
