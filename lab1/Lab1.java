...
/*******************************************************************************************************************************************************************************
 * Lab1: Tower of Hanoi
 * There are three rods which are indexed as "1", "2", "3", and there are n disks 
 * on the rod "1". The objective of your program is to move the entire stack to 
 * another rod, "3", obeying the following rules: 
...
public class Lab1
{
	...
	public String hanoi(int nDisks, int from, int to)
	{
		...
		String sol1, sol2, currentStep, solution; // String variables to contain moves
		...
		/* Fill in this part */
		/******************/
		if (nDisks==1 /* modify this (base case test) */)
		{
		...
		else
		{
			...
			sol1 = hanoi(nDisks-1, from, theOther /* modify this */);
			// Call the hanoi method recursively to make a secondary move.
			sol2 = hanoi(nDisks-1, theOther, to /* modify this */);
